...
## Setting files/paths
set verilog_files {../../dc/FIFO_system/FIFO_system.nl.v}
set my_toplevel FIFO_system
...
## Run STA 
###################################################
set rpt_file "./FIFO_system_pt.rpt"
check_timing
...
read_vcd "../../qsim_dc/FIFO_system/FIFO_system.vcd" -strip_path "testbench/FIFO_system"
...
write_sdf -context verilog "./FIFO_system.sdf"
